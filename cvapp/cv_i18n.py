...
PROFESSIONAL_REPLACEMENTS: dict[str, dict[str, str]] = {
    'de': {
        'Courses &amp; Skills Record': 'Kurse &amp; Kompetenzen',
        'Courses & Skills Record': 'Kurse & Kompetenzen',
        'Degrees &amp; Programmes': 'Abschluesse &amp; Studiengaenge',
        'Degrees & Programmes': 'Abschluesse & Studiengaenge',
        'Higher education': 'Hochschulbildung',
        'Higher Education': 'Hochschulbildung',
        'University IT &amp; Programming Coursework': 'Universitaere IT- &amp; Programmierkurse',
        'University IT & Programming Coursework': 'Universitaere IT- & Programmierkurse',
        'Individual courses': 'Einzelkurse',
        'Professional Certificates &amp; Training': 'Berufliche Zertifikate &amp; Schulungen',
        'Professional Certificates & Training': 'Berufliche Zertifikate & Schulungen',
        'Short courses': 'Kurzkurse',
        'BA Development Studies — Programme Courses': 'BA Entwicklungsstudien — Studienkurse',
        'Compulsory subjects': 'Pflichtfaecher',
        'Teaching & counseling': 'Unterricht & Beratung',
        'Office & hospitality systems': 'Buero- & Gastgewerbesysteme',
        'Career & program tools': 'Karriere- & Programmtools',
        'Professional Courses & Certifications': 'Berufliche Kurse & Zertifikate',
        'Skills &amp; Languages': 'Faehigkeiten &amp; Sprachen',
        'Skills & Languages': 'Faehigkeiten & Sprachen',
        'Awards &amp; Recognition': 'Auszeichnungen',
        'Awards & Recognition': 'Auszeichnungen',
    },
    'no': {
        'Courses &amp; Skills Record': 'Kurs- og ferdighetsoversikt',
        'Courses & Skills Record': 'Kurs- og ferdighetsoversikt',
        'Degrees &amp; Programmes': 'Grader og studieprogram',
        'Degrees & Programmes': 'Grader og studieprogram',
        'Higher education': 'Hoeyere utdanning',
        'Higher Education': 'Hoeyere utdanning',
        'University IT &amp; Programming Coursework': 'Universitetskurs i IT og programmering',
        'University IT & Programming Coursework': 'Universitetskurs i IT og programmering',
        'Individual courses': 'Enkeltemner',
        'Professional Certificates &amp; Training': 'Profesjonelle sertifikater og kurs',
        'Professional Certificates & Training': 'Profesjonelle sertifikater og kurs',
        'Short courses': 'Kortkurs',
        'BA Development Studies — Programme Courses': 'BA utviklingsstudier — programemner',
        'Compulsory subjects': 'Obligatoriske emner',
        'Teaching & counseling': 'Undervisning og veiledning',
        'Office & hospitality systems': 'Kontor- og hotellsystemer',
        'Career & program tools': 'Karriere- og programverktoy',
        'Professional Courses & Certifications': 'Profesjonelle kurs og sertifiseringer',
        'Skills &amp; Languages': 'Ferdigheter og spraak',
        'Skills & Languages': 'Ferdigheter og spraak',
        'Awards &amp; Recognition': 'Utmerkelser',
        'Awards & Recognition': 'Utmerkelser',
    },
}
...
TRANSCRIPT_REPLACEMENTS: dict[str, dict[str, str]] = {
    'de': {
        ...
        'Computer Science & IT Coursework': 'Informatik- und IT-Kurse',
        'Professional courses and skills record': 'Nachweis beruflicher Kurse und Kompetenzen',
        'Norwegian Higher Education': 'Norwegische Hochschulbildung',
        'Teaching authorization': 'Lehrbefaehigung',
        'Total Credits': 'Gesamtcredits',
        'Institutions': 'Institutionen',
        'Courses': 'Kurse',
        'Grade average': 'Notendurchschnitt',
        'Grade': 'Note',
        'Credits': 'Credits',
        'Period': 'Zeitraum',
        'Course': 'Kurs',
    ...
    'no': {
        ...
        'Computer Science & IT Coursework': 'IT- og programmeringskurs',
        'Professional courses and skills record': 'Oversikt over profesjonelle kurs og ferdigheter',
        'Norwegian Higher Education': 'Norsk hoeyere utdanning',
        'Teaching authorization': 'Undervisningsautorisasjon',
        'Total Credits': 'Totale studiepoeng',
        'Institutions': 'Institusjoner',
        'Courses': 'Emner',
        'Grade average': 'Snittkarakter',
        'Grade': 'Karakter',
        'Credits': 'Studiepoeng',
        'Period': 'Periode',
        'Course': 'Kurs',
