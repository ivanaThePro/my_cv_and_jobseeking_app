...
ROLE_CV_I18N: dict[str, dict[str, dict[str, str]]] = {
    ...
    'professional': {
        'de': {
            'label': 'Beruflicher Lebenslauf (detaillierte Kurse)',
            'description': 'Vollstaendiger Bildungsnachweis mit Kurslinks — druckfertig.',
        },
        'no': {
            'label': 'Profesjonell CV (detaljerte emner)',
            'description': 'Full utdanningsoversikt med emnelenker — klar til utskrift.',
        },
    },
}
