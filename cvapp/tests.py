...
class CVAppTests(TestCase):
    ...
    def test_professional_page_is_courses_and_skills_record(self):
        ...
        self.assertContains(response, 'How this page is organised')
        self.assertContains(response, 'Not an official university transcript')
    ...
    def test_academic_transcript_page(self):
        ...
        self.assertContains(response, 'Degrees &amp; Programmes')
        self.assertContains(response, 'id="degrees"')
        self.assertContains(response, 'id="ba-utvba"')
        self.assertContains(response, 'id="it-coursework"')
        self.assertNotContains(response, 'Norwegian Higher Education')
    ...
    def test_transcript_page_translates_to_norwegian(self):
        ...
        self.assertEqual(response.status_code, 200)
        content = response.content.decode('utf-8')
        self.assertIn('Konsolidert akademisk dokumentasjon', content)
